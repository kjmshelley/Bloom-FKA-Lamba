...
export default function TrashCanSVG() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 25 24.8" xmlSpace="preserve" className="icon-trashcan ct-delete trashcan">
